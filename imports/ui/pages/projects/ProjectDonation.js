        ...
        <div className="row donationPageContent col-md-7">
            ...
            <form>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" required  placeholder="Enter your first name"/>
                </div>
                <div className="form-group">
                    <label for="exampleInputEmail1">Last Name</label>
                    <input type="text" className="form-control" required  placeholder="Enter your last name"/>
                </div>
                <div className="form-group">
